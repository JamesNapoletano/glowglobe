...
The author creates a character profile, fills in core attributes, tracks relationships and arc progression, and references the profile while drafting or revising scenes.
...
- Whether per-character scene appearances should be auto-derived later
